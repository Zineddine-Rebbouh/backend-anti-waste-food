    ...
    def get_merchant_info(self, obj):
        try:
            ...
            return {
                ...
                "trust_score": profile.eco_score,
                "meals_saved": profile.food_saved_kg, # Or total_orders_fulfilled
                "total_orders_fulfilled": profile.total_orders_fulfilled,
                "logo_url": profile.logo_url,
                "cover_image_url": profile.cover_image_url,
                "member_since": obj.merchant.date_joined.year if obj.merchant.date_joined else 2023,
                "location": {
